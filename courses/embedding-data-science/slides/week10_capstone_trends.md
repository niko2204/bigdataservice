...
4. baseline 2개 이상과 후보 모델 비교표
5. ablation 2개 이상
6. 실패 사례 20개 이상의 taxonomy
7. 품질–latency–memory 결과
8. 안전·라이선스·개인정보 검토
9. 8분 데모와 4분 구술 방어
...
| 시간 | 내용 |
|---:|---|
| 0:00–0:45 | 사용자 문제와 실패 비용 |
| 0:45–1:30 | 데이터·정답·split |
| 1:30–3:00 | baseline과 architecture |
| 3:00–4:30 | 핵심 결과·비용·불확실성 |
| 4:30–5:45 | 오류 사례·ablation |
